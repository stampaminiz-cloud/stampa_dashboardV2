...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .rg-input:focus, .rg-select:focus { border-color: #C75D3A; background: #FFFFFF; }
  .rg-btn { width: 100%; background: #C75D3A; color: #fff; border: none; border-radius: 12px; padding: 14px; font-size: 14px; font-weight: 700; cursor: pointer; font-family: var(--font-display); margin-top: 8px; }
  ...
  .rg-card-pill:hover { border-color: #C75D3A; }
...
interface PublicCard { id: string; name: string; type: string; description?: string }
      ...
      <div className="rg-shell">
        <div className="rg-card">
          {loading ? (
            ...
            <>
              <div className="rg-business-name">{businessName}</div>
              <div className="rg-sub">Registrate en {selectedCard.name}</div>
